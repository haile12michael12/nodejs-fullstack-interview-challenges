...
const RedisCacheProvider_1 = require("../../infrastructure/cache/RedisCacheProvider");
...
describe('RedisCacheProvider', () => {
    let cacheProvider;
    beforeEach(() => {
        cacheProvider = new RedisCacheProvider_1.RedisCacheProvider(mockRedisClient);
        jest.clearAllMocks();
    });
    describe('get', () => {
...
//# sourceMappingURL=RedisCacheProvider.test.js.map